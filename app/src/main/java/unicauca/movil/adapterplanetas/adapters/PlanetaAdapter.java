package unicauca.movil.adapterplanetas.adapters;
...
import unicauca.movil.adapterplanetas.R;
...
public class PlanetaAdapter extends BaseAdapter{
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(v == null)
            v = View.inflate(context, R.layout.template_planeta, null); //importamos template

        Planeta p = data.get(i);// obtenemos objeto en esa posicion
